import {actualDate, futureDate} from '../utils/utils.js';
...
export class SearchInput {
    ...
    checkInputValidity = (input) => {
        if (input.validity.valueMissing) {
            this.form.querySelector('.error').textContent = 'Введите слово пожалуйста';
    ...
    setEventListeners = () => {
        ...
        this.form.querySelector('button').addEventListener('click', this.setReq);
    }
